...
def WriteToPDFStylo(student_number):
        ...
        pdf.cell(80)
        pdf.cell(30, 10, "Stylometry Report", 'C')
        pdf.ln(20)
        ...
        pdf.multi_cell(200, 10, txt = "Student that was investigated: " + student_number, align = 'L')
        ...
        pdf.multi_cell(200, 10, txt = burrows_delta, align = 'J')
        
        pdf.ln(20)
        pdf.set_font("Arial", 'B', size = 15)
        pdf.multi_cell(200, 10, txt = "Authorship score", align = 'C')
        pdf.ln(10)
        pdf.image(f"{os.getenv('UPLOAD_IMG')}SimiLabs_2022/flaskr/static/images/ReportImages/author_probability.png")
        pdf.ln(10)
        pdf.set_font("Arial", size = 12)
        pdf.multi_cell(200, 10, txt = authorship_score, align = 'J')

        pdf.ln(90)
        pdf.set_font("Arial", 'B', size = 15)
        pdf.multi_cell(200, 10, txt = "Receiver Operator Characteristic (ROC) Curve", align = 'C')
        pdf.image(f"{os.getenv('UPLOAD_IMG')}SimiLabs_2022/flaskr/static/images/ReportImages/operating_curve.png", w = 100, h = 100)
        pdf.ln(10)
        pdf.set_font("Arial", size = 12)
        pdf.multi_cell(200, 10, txt = ROC_curve, align = 'J')

        pdf.ln(60)
        pdf.set_font("Arial", 'B', size = 15)
        pdf.multi_cell(200, 10, txt = "Principal Component Analysis (PCA) Plot", align = 'C')
        pdf.ln(10)
        pdf.image(f"{os.getenv('UPLOAD_IMG')}SimiLabs_2022/flaskr/static/images/ReportImages/plot.png", w = 180, h = 100)
        pdf.ln(10)
        pdf.set_font("Arial", size = 12)
        pdf.multi_cell(200, 10, txt = PCA_curve, align = 'J')
